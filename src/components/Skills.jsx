...
export default function Skills() {
  return (
    <div id="skills" style={{ padding: "100px 20px", maxWidth: "800px", margin: "0 auto" }}>
      <p style={{ color: "#e91e8c", letterSpacing: "4px", fontSize: "0.9rem", marginBottom: "12px" }}>SKILLS</p>
      <h2 style={{ color: "white", fontSize: "2.5rem", marginBottom: "48px" }}>技能</h2>
